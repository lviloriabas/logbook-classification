...
def test_combo_rewrites_only_csv_between_specific_day_and_month_end(window):
    template = Template(
        name="fecha",
        fields=[
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        # La lista abre en la ultima politica elegida; se parte de «Fin de
        # mes» antes de darle la ejecucion, que es cuando empieza a
        # reescribir el CSV.
