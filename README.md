...
Esa regla también se usa para corregir: la lectura que contradice a las dos páginas que la rodean se rehace con el valor más parecido al leído que el libro admite, y queda marcada con la lectura anterior entre sus alternativas. Una fecha posterior a la ejecución no existe (la página no se firma después de escanearse), así que se aparta y la completa el libro con el día que cabe en la secuencia; si no puede, la página se queda sin fecha y el CSV escribe el último día del mes. En ninguno de los dos casos pasa a revisión por eso: un día mal leído no obliga a teclear a mano lo que el resto de la fecha ya dice bien. Una fecha se revisa por antigua cuando pasa del año: se conserva tal como se leyó, pero va a REVISAR aunque todo el libro coincida, porque un año justo de diferencia casi siempre es el año mal leído. El atraso de unos meses que arrastra cualquier entrega no se revisa. El día que nadie leyó (la opción Fin de mes o el relleno del libro) se comprueba por mes, porque no procede de la escritura.
