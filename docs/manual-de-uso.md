...
5. Confirme el nombre del batch y el **Máximo por batch**. La copia portable empieza en 200 páginas y después recuerda la última cantidad elegida aquí o en **Repartir en**; los PDF que la superen se dividen para Quick Upload sin modificar la entrega ni el CSV. Deje **Sesión** vacío. En el primer acceso, complete el inicio de sesión y el segundo factor en Edge. Si una carga no aparece con el nombre esperado, la ventana revisa tres veces nombres, páginas y contenido; solo después empieza una espera de 30 minutos antes de ofrecer otra subida. Puede elegir otra ejecución mientras una está trabajando: se abre en otra ventana y las dos avanzan simultáneamente.
